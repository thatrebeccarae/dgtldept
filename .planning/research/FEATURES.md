...
|---------|--------------|------------|-------|
| Per-skill README/documentation | Every plugin catalog (VS Code, Obsidian, Raycast, npm) surfaces a description, what it does, prerequisites, and installation steps. Absent = abandoned project signal. | LOW | Already partially exists in klaviyo-skill-pack. Needs standardization into a repeatable template. |
...
- [Existing repo — klaviyo-skill-pack README](https://github.com/thatrebeccarae/claude-code-skills/blob/main/skill-packs/klaviyo-skill-pack/README.md) — Direct read of existing skill pack structure. Confidence: HIGH (primary source).
